...
void main() {
	switch(Random(2)) {
        case 0:
            spawn_npc("010_cr_an_deer_male");
            break;
        default:
	    // add kids and a family every once in a while
            spawn_npc("010_cr_an_deer_female");
            spawn_npc("010_cr_an_deer_male",0.1);
            spawn_npc("010_cr_an_deer_baby",0.25);
            spawn_npc("010_cr_an_deer_baby",0.25);
            spawn_npc("010_cr_an_deer_baby",0.25);
	}
}
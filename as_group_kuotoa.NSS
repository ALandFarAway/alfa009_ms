...
void main() {
	...
	spawn_hostile_npc("abr_cr_hu_kuotoa_crazed",0.5);
	spawn_hostile_npc("abr_cr_hu_kuotoa_crazed",0.5);
	spawn_hostile_npc("abr_cr_hu_kuotoa_crazed",0.5);
	spawn_hostile_npc("abr_cr_mh_kuotoa_0020",0.5);
	spawn_hostile_npc("abr_cr_mh_kuotoa_003",0.5);
	spawn_hostile_npc("abr_cr_mh_kuotoa_003",0.5);
	spawn_hostile_npc("abr_cr_mh_kuotoa_0020",0.2);
	spawn_hostile_npc("abr_cr_mh_kuotoa_004",0.2);
	spawn_hostile_npc("abr_cr_mh_kuotoa_004",0.2);
}
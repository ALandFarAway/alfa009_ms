...
void main() {
	...
	spawn_hostile_npc("010_ud_orog1",0.5);
	spawn_hostile_npc("010_ud_orog1",0.5);
	spawn_hostile_npc("010_ud_orog2",0.5);
	spawn_hostile_npc("010_ud_orog2",0.5);
	spawn_hostile_npc("010_ud_orog3",0.5);
	spawn_hostile_npc("010_ud_orog3",0.5);
	spawn_hostile_npc("010_ud_orogmerc1",0.2);
	spawn_hostile_npc("010_ud_orogmerc2",0.2);
	spawn_hostile_npc("010_ud_orogmerc3",0.2);
	spawn_hostile_npc("010_ud_orogmerc4",0.2);
}